Shader "_workaround/lilToonMultiOutlineWebGL"
{
    Properties
    {
        //----------------------------------------------------------------------------------------------------------------------
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            // Replace keywords
            #include "Packages/jp.lilxyzw.liltoon/Shader/Includes/lil_replace_keywords.hlsl"

            //----------------------------------------------------------------------------------------------------------------------
            // Pass
            #include "Packages/jp.lilxyzw.liltoon/Shader/Includes/lil_pipeline_urp.hlsl"
        ...
        Pass
        {
            ...
            #include "Packages/jp.lilxyzw.liltoon/Shader/Includes/lil_pass_depthonly.hlsl"
        ...
        Pass
        {
            ...
            #include "Packages/jp.lilxyzw.liltoon/Shader/Includes/lil_pass_depthnormals.hlsl"
        ...
        Pass
        {
            ...
            #include "Packages/jp.lilxyzw.liltoon/Shader/Includes/lil_pass_motionvectors.hlsl"
        ...
        Pass
        {
            ...
            #include "Packages/jp.lilxyzw.liltoon/Shader/Includes/lil_pass_universal2d.hlsl"
